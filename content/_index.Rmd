...
We describe in this Web site an approach to *declaring* the elements of a research design in code and *diagnosing* the properties of the design, such as power and sampling bias, given assumptions. We outline the [Model-Inquiry-Data Strategy-Analysis Strategy (MIDA) approach](/mida), with further details in our [working paper](https://paper.declaredesign.org/paper.pdf).
