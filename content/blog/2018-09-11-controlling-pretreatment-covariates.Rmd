...
We diagnose the modified design:
...
```{r, fig.cap="Note: Correlation between Z and Y introduced by controlling for X. Red dots for Z = 1 cases, blue for Z = 0", echo=TRUE, eval = TRUE}
