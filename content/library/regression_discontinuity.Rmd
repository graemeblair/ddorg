...
# Design ------------------------------------------------------------------
declare_design(
 population, potential_outcomes, estimand, sampling, declare_reveal(), estimator)
}
...
<div class="btn-group">
  <a class="btn btn-primary" href="/library/regression_discontinuity.R">
    <i class="fa fa-code" title = "Download code for design" fa-2x></i> Download code
  </a>
  <a class="btn btn-primary" href="/library/regression_discontinuity_template.RDS">
