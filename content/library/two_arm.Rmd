  ...
  sigma = c(1, .1, .5, 1.5, 2) )
{
  ...
  potential_outcomes <- declare_potential_outcomes(
	...
	declare_design(
		population, potential_outcomes, sampling, estimand, assignment, declare_reveal(), estimator)
}
...
<div class="btn-group">
  <a class="btn btn-primary" href="/library/two_arm.R">
    <i class="fa fa-code" title = "Download code for design" fa-2x></i> Download code
  </a>
  <a class="btn btn-primary" href="/library/two_arm_template.RDS">
...
two_arm <- declare_design(population, potential_outcomes, sampling,
													estimand, assignment, declare_reveal(), estimator)
```
