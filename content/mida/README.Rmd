...
To go further, you can [get started using `DeclareDesign` in `R`](https://declaredesign.org/getting-started/), [check out our design library](https://declaredesign.org/library/) for more diagnoses of common designs, and [read our paper](https://declaredesign.org/declare.pdf) for an overview of the conceptual framework behind `DeclareDesign`.
