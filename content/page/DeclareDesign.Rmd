...
Next, we recommend you read the [Custom functions](/page/custom_functions/) tutorial to learn how to provide custom functions to replace any step of `declare_design()`. You can also read about [`quick_design()` and other advanced features](/page/advanced_features/) in our Advanced features tutorial.

Finally, you can [learn about DeclareDesign’s companion packages](/page/companion_packages/).
